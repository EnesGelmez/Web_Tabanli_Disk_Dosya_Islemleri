...
function sqlara(){
                                ...
                                foreach(scandir($dosyayolu) as $dosyaadi){
                                    ...
                                    if (!($dosyaadi == '..')) {
                                        ...
                                        if($date==$mdateval){ 
                                            ...
                                            if($mime_content==$typeval||$deger==$sizeval||$dosyaadi==$nameval||$substr==$permisval)
                                            {
                                ...
                                if($diziname3[$j]==$name){
                                    ...
                                    foreach(scandir($dosyayolu) as $dosyaadi){
                                        ...
                                        if (!($dosyaadi == '..')) {
                                            ...
                                            $substr=substr(sprintf('%o', fileperms($dosyayolu2)), -4);
                                            if($dosyaadi==$nameval){
                                                if($mime_content==$typeval||$deger==$sizeval||$date==$mdateval||$substr==$permisval)
                                                {
                                    ...
                                    if($diziname3[$j]==$permis){
                                        ...
                                        foreach(scandir($dosyayolu) as $dosyaadi){
                                            ...
                                            if (!($dosyaadi == '..')) {
                                                ...
                                                $substr=substr(sprintf('%o', fileperms($dosyayolu2)), -4);
                                                if($substr==$permisval){ 
                                                    if($mime_content==$typeval||$deger==$sizeval||$date==$mdateval||$dosyaadi==$nameval)
                                                    {
                            ...
                            if($diziname3[$j]==$permis){                                
                                ...
                                foreach(scandir($dosyayolu) as $dosyaadi){
                                    ...
                                    if (!($dosyaadi == '..')) {
                                        ...
                                        $substr=substr(sprintf('%o', fileperms($dosyayolu2)), -4);
                                        if($substr==$permisval){ 
                                            if($deger==$sizeval&&($dosyaadi==$nameval||$mime_content==$typeval||$date==$mdateval))
                                            {                                                
                                                echo ("<script>document.getElementById('dosyaizinkutu').innerHTML+='$substr<br>';</script>"); 
                                                $dosyaadinum = ($dosyaadinum + 1);   
                                            } 
                                            else if($dosyaadi==$nameval||$mime_content==$typeval||$date==$mdateval||$deger==$sizeval)
                                            {
                                                echo ("<script>document.getElementById('dosyaizinkutu').innerHTML+='$substr<br>';</script>"); 
                                                $dosyaadinum = ($dosyaadinum + 1); 
                                            }                                      
    ...
    <?php
        ...
        for($i=0;$i<count($diziname2);$i++){  
                           
                $harf=substr($diziname2[$i] ,1);
                if(count($diziname2)==5)
                {
                    if($harf=="n")
                    {
                        $dizinamey [0]=$diziname2 [$i];        
                    }
                    if($harf=="t")
                    {
                        $dizinamey [1]=$diziname2 [$i];        
                    }
                    
                    if($harf=="s")
                    {
                        $dizinamey [2]=$diziname2 [$i];        
                    }
                    
                    if($harf=="m")
                    {
                        $dizinamey [3]=$diziname2 [$i];        
                    }
                    
                    if($harf=="p")
                    {
                        $dizinamey [4]=$diziname2 [$i];        
                    }
                }
